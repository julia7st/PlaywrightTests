...
export class WorkSpacePage {
  ...
  constructor(page: Page) {
    ...
    this.getTablePage = page.locator("xpath=//a[contains(text(),'Simple table')]");
    this.getElementsPage = page.locator("xpath=//a[contains(text(),'Find Elements')]")
    this.getDropDownPage = page.locator("xpath=//a[contains(text(),'Drop-Down')]")
  }
};